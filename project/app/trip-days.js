/* trip-days.js — the day-by-day plan for the companion app.
   ...
   Source of truth: Plan-E-Itinerary.md + the route in js/data.js. */
(function (global) {
  ...
  function geo(name, coord) { return { name: name, coord: coord }; }
  ...
  global.TRIP_DAYS = DAYS;
  global.TRIP_COORDS = C;
})(window);
